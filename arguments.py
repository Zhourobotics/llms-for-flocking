...
def parse_cli_arguments():
    ...
    parser.add_argument("--spawn_x_max", "-sxma", type=float, default=100.0,
    ...
    parser.add_argument("--spawn_y_max", "-syma", type=float, default=100.0,
                        help="Upper bound of the agent's random spawn range's y coordinate")

    parser.add_argument("--rounds", "-t", type=int, default=50,
    ...
    parser.add_argument("--memory_limit", "-mlim", type=int, default=1,
                        help="Message history each agent remembers")
    parser.add_argument("--model", "-gpt", type=str, default="ft:gpt-3.5-turbo-1106:zhou-lab::8u49BlQh",  # gpt-4-1106-preview
                        help="Message history each agent remembers")
    # For plotting
    ...
    parser.add_argument("--y_min", "-pymi", type=int, default=-20,
                        help="Lower bound of plot")
    parser.add_argument("--y_max", "-pyma", type=int, default=130,
